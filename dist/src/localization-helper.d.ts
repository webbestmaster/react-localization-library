...
import { LocalizationDataType, LocalizationType } from "./localization-type";
export declare function getLocalizedString<TranslationKeys extends string, LocaleName extends string>(stringKey: TranslationKeys, localeName: LocaleName, localization: LocalizationDataType<TranslationKeys>, valueMap?: Record<string, string>): string;
